...
public class LocalStorageService {
    ...
    public StoredFile storeBytes(byte[] content, String originalName, String category, String contentType) {
        ...
        try {
            ...
            return new StoredFile(originalName, relativePath.toString(), contentType, content.length);
        } catch (IOException exception) {
            throw new BusinessException("FILE_STORE_FAILED", "文件保存失败");
        }
    }
